      ...
      <div class="row justify-content-between d-print-none">
        <div class="col-md-6">
          <div class="row justify-content-between">
            ...
            <div class="col-4">
              <a href="<?= base_url('/admin/transaksi'); ?>" class="btn btn-outline-secondary d-block">Tampilkan Semua</a>
            </div>
          </div>
        </div>
        <div class="col-md-2">
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th class="d-none d-xl-table-cell d-print-table-cell">Nama Pemesan</th>
              <th>Nama Pesanan</th>
              <th class="d-none d-xl-table-cell d-print-table-cell">Tipe</th>
              <th>Total</th>
              <th class="d-print-none d-none d-xl-table-cell">Kode Pembayaran
                / VA_Number</th>
              <th class="d-print-none d-none d-xl-table-cell">Kode Status</th>
              <th>Status Transaksi</th>
              <th class="d-print-none d-none d-xl-table-cell">URL PDF</th>
            </tr>
          </thead>
          <tbody>
            <?php foreach ($transaksi as $t) : ?>
              <tr>
                ...
                <td class="d-none d-xl-table-cell d-print-table-cell"><?= $t['customer_name']; ?></td>
                <td><?= $t['item_name']; ?></td>
                ...
                <td class="d-print-none d-none d-xl-table-cell"><?= $t['status_code']; ?></td>
                <td>
                ...
                <td class="d-print-none d-none d-xl-table-cell">
                  <?php if ($t['pdf_url'] == '') : ?>
                    Tidak ada link pdf
                  <?php else : ?>
                    <a class="badge bg-primary" href="<?= $t['pdf_url']; ?>">PDF</a>
                  <?php endif; ?>
                </td>
              </tr>
            <?php endforeach; ?>
